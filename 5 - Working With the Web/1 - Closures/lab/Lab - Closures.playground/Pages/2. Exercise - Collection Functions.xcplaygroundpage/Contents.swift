 ...
 */
let people = ["ben", "sam", "kol"]

let sortedCollection1 = people.sorted(by: forwards)
 ...
 */
let sortedCollection2 = people.sorted { (name1: String, name2: String) in
return name1 < name2
 ...
 */
let sortedCollection3 = people.sorted { $0 < $1
