...
//print("The value of foo is \(foo)")
// because the print statement is outside the {}
...
// because x is a global scope at the top then its pulled into the function and incremented by 1 ten times until the final value is 20. Foo is only defined inside the for loop and can not be accessed outside the {}
...
greeting(greeting: "hello", name: "nick")
